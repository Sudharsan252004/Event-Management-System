...
/**
 * Servlet implementation class corporateServelet
 */
@WebServlet("/corporateServelet")
public class corporateServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public corporateServelet() {
        super();
		 ...
		 PrintWriter out = response.getWriter();
		    ...
		    try {
		        ...
		        if (conn != null) {
		            ...
		            if (row > 0) {
		                RequestDispatcher rd = request.getRequestDispatcher("corporatereg.html");
