...
/**
 * Servlet implementation class concertServelet
 */
@WebServlet("/concertServelet")
public class concertServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public concertServelet() {
        super();
		 ...
		 PrintWriter out = response.getWriter();
		    ...
		    try {
		        ...
		        if (conn != null) {
		            ...
		            if (row > 0) {
		                RequestDispatcher rd = request.getRequestDispatcher("concertreg.html");
