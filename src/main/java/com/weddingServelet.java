...
/**
 * Servlet implementation class weddingServelet
 */
@WebServlet("/weddingServelet")
public class weddingServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public weddingServelet() {
        super();
		    ...
		    try {
		        ...
		        PreparedStatement ps= connection.getConnection().prepareStatement(query);
		            ...
		            if (ps.executeUpdate()> 0) {
		                RequestDispatcher rd = request.getRequestDispatcher("weddingreg.html");
