...
/**
 * Servlet implementation class familyServelet
 */
@WebServlet("/familyServelet")
public class familyServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public familyServelet() {
        super();
		 ...
		 PrintWriter out = response.getWriter();
		    ...
		    try {
		        ...
		        if (conn != null) {
		            ...
		            if (row > 0) {
		                RequestDispatcher rd = request.getRequestDispatcher("familyreg.html");
